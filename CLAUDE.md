...
**YOU ARE IN: `bane_pwa/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/bane_pwa/` (rig root) or other directories
...
**Your mail address:** `bane_pwa/polecats/chrome`
**Your rig:** bane_pwa
**Your Witness:** `bane_pwa/witness`
...
| Ask Witness for help | `gt mail send bane_pwa/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`bane_pwa/witness`) when:
...
```bash
gt mail send bane_pwa/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
